...
import 'package:growify/controller/home/OptionAboutPost_Controller/editPostPage_controller.dart';
...
class EditPostPage extends StatelessWidget {
  ...
  final EditPostPageControllerImp controller =
      Get.put(EditPostPageControllerImp());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Padding(
        ...
        child: GetBuilder<EditPostPageControllerImp>(
          init: controller,
          builder: (controller) {
            return GestureDetector(
              ...
              child: ListView(
                children: [
                  Row(
                    children: [
                      ...
                      DropdownButton<String>(
                        value:
                            controller.selectedPrivacy.value ?? selectedPrivacy,
                        items: [
                          'Any One',
                          'Connections',
                  ...
                  const SizedBox(height: 16),
                  GetBuilder<EditPostPageControllerImp>(
