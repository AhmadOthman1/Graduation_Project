...
class PeerCallScreen extends StatefulWidget {
  final String callerId, calleeId;
  final dynamic offer;
  final socket;
  const PeerCallScreen({
    super.key,
    this.offer,
  ...
  @override
  State<PeerCallScreen> createState() => _PeerCallScreenState();
}

class _PeerCallScreenState extends State<PeerCallScreen> {
  // socket instance
