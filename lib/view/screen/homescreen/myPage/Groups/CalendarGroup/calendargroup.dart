...
import 'package:growify/controller/home/Groups_controller/groupcalendar.dart';
import 'package:table_calendar/table_calendar.dart';

class GroupCalender extends StatefulWidget {
  const GroupCalender({super.key});

  @override
  _GroupCalenderState createState() => _GroupCalenderState();
}

class _GroupCalenderState extends State<GroupCalender> {
  ...
  GroupCalendarController controller =
      Get.put(GroupCalendarController());
