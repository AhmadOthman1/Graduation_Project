...
class NewPostControllerImp extends GetxController {
  ...
  postNewPost(postImageBytes, postImageBytesName, postImageExt) async {
  ...
  post(postImageBytes, postImageBytesName, postImageExt) async {
    var res =
        await postNewPost(postImageBytes, postImageBytesName, postImageExt);
